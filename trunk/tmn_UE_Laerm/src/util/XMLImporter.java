...
public class XMLImporter {
	...
	public static void XML_IMPORTER_Class_inANutshell() {
		...
		PApplet.println(XMLImporter.getObsctlObjectPropertys(0, "day",
				"private"));
	 ...
	 * @return float
	 */
	public static float getObsctlObjectPropertys(int id, String time,
			String space) {
		root = new XMLElement(p, "./data/affectionPropertys.xml");
		XMLElement obstcls[] = root.getChildren("obstclObject");
		...
		if (id < obstcls.length) {
			...
			if (time.equals("day") == true) {
				...
				if (space.equals("private") == true) {
					...
					return obstcls[id].getChild("day/private").getIntAttribute(
							"value");
				} else if (space.equals("public") == true) {
					return obstcls[id].getChild("day/public").getIntAttribute(
							"value");
				} else if (space.equals("work") == true) {
					return obstcls[id].getChild("day/work").getIntAttribute(
							"value");
				} else {
					return 0.0f;
				}
				...
				if (space.equals("private") == true) {
					return obstcls[id].getChild("nite/private")
							.getIntAttribute("value");
				} else if (space.equals("public") == true) {
					return obstcls[id].getChild("nite/public").getIntAttribute(
							"value");
				} else if (space.equals("work") == true) {
					return obstcls[id].getChild("nite/work").getIntAttribute(
							"value");
				} else {
	...
	public static int[][] ObjectPropertys(int id, XMLElement root) {
		...
		if (id < obstcls.length) {
			...
			propertys[0][1] = obstcls[id].getChild("day/public")
					.getIntAttribute("value");
			propertys[0][2] = obstcls[id].getChild("day/work").getIntAttribute(
					"value");
